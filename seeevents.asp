                    ...
                    <TR>
                        ...
                        align=center bgColor=#00ccff border=0>
                              ...
                              align=center bgColor=#0034a0 border=0>
                                ...
                                color=#ffffff size=2>All 'Active' Events posted to <%=now %> </FONT></DIV>
                                      </TD>
...
<center><A HREF="Seedeevents.asp">Click here to see Deactivated Events</a></center>
                                  <P> 
                                  <CENTER>
...
strSQL2 = "Select * FROM product where status = 'active' order by event_date asc"
...
If not rst.eof then
	...
	strtxt = "SELECT COUNT(*) AS TotalItem FROM product where status = 'active'"
...
%>
                                      <TR> 
                                        <center>
                                          ...
                                          <TD><font size=-1><%= rst("Unit_Price_adult") %></font></TD>
...
%>
								  ...
								  <%
									...
									if page <> 0 then
									  page1 = page - 10
									%>
									  <a href=seeevents.asp?page=<% =page1 %>>[Previous]</a>&nbsp&nbsp
									<%
									end if
									...
									%>
									    <a href=seeevents.asp?page=<% =page2 %>>[Next]</a>
									<%
									  end if
									end if
									%></center>
